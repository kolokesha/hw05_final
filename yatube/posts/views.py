...
def follow_index(request):
    ...
    following_users = get_object_or_404(Follow, user=user)
    follower_posts = Post.objects.filter(author=following_users.author)
